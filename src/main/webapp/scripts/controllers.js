...
angular.module('webappApp')
    ...
    .controller('MainController', function ($scope, $rootScope, $location,appService, DIAGRAM_CONSTANTS, DIALOG_CONSTANTS,ERROR_STRING_CONSTANTS,CONSTANT_FACTORY, PHY_SIZER_CONSTANTS) {
        ...
        $scope.loadApplication = function () {
            ...
            appService.getNodeConnection(function (resp) {
                var log = [];
                var data = resp.app;
                angular.forEach(data.nodes, function (value, key) {
			...
			$scope.updateNodePositions = function()
			{
				...
				appService.updateNodePositions(data, function (resp) {
				});
			}
		...
		$scope.getNumberOfNodes = function(type) {
			...
			shapes.forEach(function(shape){
				...
				if (((type == "contract") && ((shape.type=="contract") || (shape.type=="contractl3")))
					|| ((type == "contractl3") && ((shape.type=="contract") || (shape.type=="contractl3")))
					|| ((type =="epg") && (shape.type=="epg")))
                {
					count++;
				}
			});
            ...
            var appDataSource = new aci.data.DataSource({
                ...
                transport: {
                    ...
                    update: function (options) {
                        ...
                        if (options.data.isSaved == false) {
                            if (options.data.type == "epg") {
                                ...
                                appService.addEpg(options.data, function (resp) {
                            ...
                            else if (options.data.type == "contract")
                            {
								...
								options.data.providerId = {
									...
									appService.addContract(options.data, function (resp) {
										$rootScope.canceler.resolve();
										$scope.showLoadingImage();
										 appService.getSizingResults(function(resp){
							                	$rootScope.currProject=resp;
                            ...
                            if (options.data.type == "epg") {
                                appService.updateEpg(options.data, function (resp) {
									$rootScope.canceler.resolve();
									$scope.showLoadingImage();
                                	 appService.getSizingResults(function(resp){
                                     	$rootScope.currProject=resp;
                                ...
                                appService.updateContract(options.data, function (resp) {
									$rootScope.canceler.resolve();
									$scope.showLoadingImage();
                                	 appService.getSizingResults(function(resp){
                                     	$rootScope.currProject=resp;
                                ...
                                appService.updateApplication(options.data, function (resp) {
									$rootScope.canceler.resolve();
									$scope.showLoadingImage();
                                	 appService.getSizingResults(function(resp){
                                     	$rootScope.currProject=resp;
                    ...
                    create: function (options) {
                        ...
                        appService.getUuid(options.data, function (resp) {
            ...
            function onEdit(e) {
               // e.shape.dirty=true;
                ...
                if (e.shape.type === "epg") {
					...
					if (!e.shape.pKey) {
						appService.getNodeDefaultValues("epg", function (resp) {
						 ...
						 appService.getEpgDetails(e.shape.pKey, function (resp) {
							 $("#epgSubnets").getAciNumericTextBox().value(resp.epgSubnets);
							 $("#epgSpan").getAciNumericTextBox().value(resp.span);
							 $("#epgEndPoints").getAciNumericTextBox().value(resp.noOfEndPoints);
							 $("#sharedfilter").getAciNumericTextBox().value(resp.noOfsharedServiceFilter);
				...
				//	document.getElementById('contractproviderId').disabled = true;
                    ...
                    if (!e.shape.pKey) {
						appService.getNodeDefaultValues("contractshared", function (resp) {
                ...
                click: function(e){                                                   
                    ...
                    if(e.item.dataItem.type == "epg"){
                       var template = aci.template($("#epg-node-template").html()); 
                         appService.getEpgDetails(e.item.dataItem.pKey, function (resp){
                       ...
                       appService.getContractDetails(e.item.dataItem.pKey, function (resp){
...
//else
			...
			var highlightNodes = function(element) {
				...
				if (element.dataItem.type == "epg") {
					...
					// highlight l3out
					$scope.selectedl3out = [];
					appService.getEpgContracts(element.dataItem.pKey, function (resp) {
					...
					appService.getContractDetails(element.dataItem.pKey, function (resp) {
						shapes.forEach(function(shape){
							if(shape.dataItem.type == "l3out"){
                        ...
                        if (options.data.isSaved == false) {
                            if (options.data.type == "vrf") {
                               // options.data.status = options.data.status.value;
                                ...
                                appService.addVrf(options.data, function (resp) {
									$scope.showLoadingImage();
									$rootScope.canceler.resolve();
                                	 appService.getSizingResults(function(resp){
                                     	$rootScope.currProject=resp;
                                ...
                                appService.addBd(options.data, function (resp) {
                                ...
                                appService.addL3out(options.data, function (resp) {
                                	$rootScope.canceler.resolve();
									$scope.showLoadingImage();
                                	 appService.getSizingResults(function(resp){
                                     	$rootScope.currProject=resp;
                            ...
                            if (options.data.type == "vrf") {
                                ...
                                appService.updateVrf(options.data, function (resp) {
                                	$rootScope.canceler.resolve();
									$scope.showLoadingImage();
                                	 appService.getSizingResults(function(resp){
                                     	$rootScope.currProject=resp;
                                ...
                                appService.updateBd(options.data, function (resp) {
                                	$rootScope.canceler.resolve();
									$scope.showLoadingImage();
                                	 appService.getSizingResults(function(resp){
                                     	$rootScope.currProject=resp;
                                ...
                                appService.updateL3out(options.data, function (resp) {
                                	$rootScope.canceler.resolve();
									$scope.showLoadingImage();
                                	 appService.getSizingResults(function(resp){
                                     	$rootScope.currProject=resp;
                                ...
                                appService.updateSharedResource(options.data, function (resp) {
                                	$rootScope.canceler.resolve();
									$scope.showLoadingImage();
                                	appService.getSizingResults(function(resp){
                                     	$rootScope.currProject=resp;
            ...
            function onEditFabric(e) {
                ...
                if (e.shape.type === "vrf") {
					if (e.shape.pKey) {
						...
						appService.getNodeDefaultValues("vrf", function (resp) {
					...
					if (e.shape.pKey) {
					   ...
					   appService.getbdDetails(e.shape.pKey, e.shape.vrfId, e.shape.vrfName, function (resp) {
						...
						appService.getNodeDefaultValues("bd", function (resp) {
					...
					if (e.shape.pKey) {
					   document.getElementById("vrf").disabled = true;
					   e.shape.vrf = e.shape.vrfName;
					   appService.getl3Details(e.shape.pKey, e.shape.vrfId, e.shape.vrfName, function (resp) {
							 e.shape.vrf = resp.vrfName;
							 $("#vrf").aciComboBox({
								dataTextField: "text",
								dataValueField: "value",
					   ...
					   e.shape.vrfId = $scope.nearestvrf.dataItem.id;
						...
						$("#subif").aciNumericTextBox({format: 'n0'});
						$("#svi").aciNumericTextBox({format: 'n0'}); 
						appService.getNodeDefaultValues("l3out", function (resp) {
					...
					if (e.shape.pKey) {
						var vrfs= getAllVrfs();
						document.getElementById("vrf").disabled = true;
					    appService.getVrfDetails(e.shape.vrf, e.shape.fullName, function (resp) {
...
*/
        ...
        $scope.updateTenantList = function () {
            appService.getTenants(function (resp) {
	   ...
	   $scope.getTenantIndex = function(name) {
        ...
        $scope.getApplicationsForTenant = function () {
            ...
            appService.getApplications(function (resp) {
        ...
        $scope.addApplication = function (jsonObj) {
            appService.addApplication(jsonObj, function (resp) {
				$rootScope.canceler.resolve();
				$scope.showLoadingImage();
            	appService.getSizingResults(function(resp){
                 	$rootScope.currProject=resp;
	  ...
	  $scope.getApplicationIndex = function(name) {
		...
		$scope.createApplicationListDropDown = function() {
        ...
        $scope.openTenantWindow = function () {
			...
			// Default values
			appService.getTenantDefaultValues(function (resp) {
		...
		$scope.deleteTenant = function(){
            $rootScope.tenantId = $rootScope.tenantList[$rootScope.selectedTenantIndex].id;
            appService.deleteTenant(function (resp) {
				$scope.showLoadingImage();
				$rootScope.canceler.resolve();
            	 appService.getSizingResults(function(resp){
                 	$rootScope.currProject=resp;
		...
		$scope.deleteApp = function(){
            $rootScope.appId = $rootScope.applicationList[$rootScope.selectedApplicationIndex].id;
            appService.deleteApplication(function (resp) {
				$rootScope.canceler.resolve();
				$scope.showLoadingImage();
            	 appService.getSizingResults(function(resp){
                 	$rootScope.currProject=resp;
		...
		$scope.onDeleteNode = function(){
			 if ($scope.deleteNode.type == "vrf") {
			   appService.deleteVrf($scope.deleteNode, function (resp) {
				   $rootScope.canceler.resolve();
				   $scope.showLoadingImage();
				   appService.getSizingResults(function(resp){
	                	$rootScope.currProject=resp;
				 ...
				 appService.deleteBd($scope.deleteNode, function (resp) {
					 $rootScope.canceler.resolve();
					 $scope.showLoadingImage();
					 appService.getSizingResults(function(resp){
		                	$rootScope.currProject=resp;
				 ...
				 appService.deleteL3out($scope.deleteNode, function (resp) {
					 $rootScope.canceler.resolve();
					 $scope.showLoadingImage();
					 appService.getSizingResults(function(resp){
		                	$rootScope.currProject=resp;
				 ...
				 appService.deleteSharedResource($scope.deleteNode, function (resp) {
					 $rootScope.canceler.resolve();
					 $scope.showLoadingImage();
					 appService.getSizingResults(function(resp){
		                	$rootScope.currProject=resp;
				  ...
				  appService.deleteEpg($scope.deleteNode, function (resp) {
					  $rootScope.canceler.resolve();
					  $scope.showLoadingImage();
					  appService.getSizingResults(function(resp){
		                	$rootScope.currProject=resp;
    		 ...
    		 {
				   appService.deleteContract($scope.deleteNode, function (resp) {
					   $rootScope.canceler.resolve();
					   $scope.showLoadingImage();
					   appService.getSizingResults(function(resp){
		                	$rootScope.currProject=resp;
	 ...
	 $scope.getInputJSON = function(){
            appService.getInputJSON(function (resp) {
    ...
    $scope.toggleModal = function(){
	    ...
	    //    $rootScope.fadeOutBackground();
			...
			appService.getNodeDefaultValues("app", function (resp) {
				$scope.addApp = {
					name: resp.name,
  ...
  /* $scope.l3SliderEnable = function(){            
    ...
    $scope.chooseSwitchesFromPhySizer = function(){
    	...
    	appService.getRooms(function(resp) {
	...
	$scope.activeRoomItem = function(index, id){
    	...
    	appService.preferredSwitch(jsonObj, function (resp) {
    		$rootScope.canceler.resolve();
			$scope.showLoadingImage();
