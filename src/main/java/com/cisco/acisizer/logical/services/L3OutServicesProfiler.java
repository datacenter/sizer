...
import com.cisco.acisizer.exceptions.L3OutNameExistsException;
 ...
 */
@Service
public class L3OutServicesProfiler {
	...
	private void inputMapping(com.cisco.acisizer.ui.models.L3outUi src, L3out dest) {
	 ...
	 * @param dest
	 */
	private void commonMapping(com.cisco.acisizer.ui.models.L3outUi src, L3out dest) {
	...
	public com.cisco.acisizer.ui.models.L3outUi outputMapping(L3out src, com.cisco.acisizer.ui.models.L3outUi dest, Vrf vrf,
			Tenant currTenant) {
		dest.setCount(src.getCount());
	...
	public com.cisco.acisizer.ui.models.L3outUi addL3Out(int projectId, int tenantId, int vrfId,
			com.cisco.acisizer.ui.models.L3outUi l3out) throws AciEntityNotFound {
...
/*		String updatedTenants = gson.toJson(logicalRequirement);
		...
		if (returnProj != null) {
			return outputMapping(l3outToAdd, new com.cisco.acisizer.ui.models.L3outUi(), currVrf, currTenant);
		} else {
			return null;
		}
	...
	public com.cisco.acisizer.ui.models.L3outUi getL3Out(int projectId, int tenantId, int vrfId, int l3OutId)
...
*/		
		...
		return outputMapping(l3outequired, new com.cisco.acisizer.ui.models.L3outUi(), currVrf, currTenant);
...
*/
	...
	public com.cisco.acisizer.ui.models.L3outUi updateL3Out(int projectId, int tenantId, int vrfId, int l3OutId,
			com.cisco.acisizer.ui.models.L3outUi l3out) throws AciEntityNotFound, ForbiddenOperationException {
