...
@RestController
public class ContractController extends AciController {

	@Autowired
	private ContractServices m_service;
	...
	@RequestMapping(value = "/acisizer/v1/project/{projectId}/tenant/{tenantId}/app/{appId}/contract", method = RequestMethod.POST, produces = "application/json")
	@ResponseBody
	...
	@RequestMapping(value = "/acisizer/v1/project/{projectId}/tenant/{tenantId}/app/{appId}/contract/{contractId}", method = RequestMethod.PUT, produces = "application/json")
	@ResponseBody
	...
	@RequestMapping(value = "/acisizer/v1/project/{projectId}/tenant/{tenantId}/app/{appId}/contract/{contractId}", method = RequestMethod.DELETE, produces = "application/json")
	@ResponseBody
	...
	@RequestMapping(value = "/acisizer/v1/project/{projectId}/tenant/{tenantId}/app/{appId}/contract/{contractId}", method = RequestMethod.GET, produces = "application/json")
	@ResponseBody
