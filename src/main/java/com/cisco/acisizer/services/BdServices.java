...
import com.cisco.acisizer.exceptions.BdNameExistsException;
...
public class BdServices {
	...
	public Bd inputMapping(int bdId, com.cisco.acisizer.ui.models.BdUi bd) {
	 ...
	 * @param bdDest
	 */
	private void commonMapping(com.cisco.acisizer.ui.models.BdUi bd, Bd bdDest) {
	...
	public com.cisco.acisizer.ui.models.BdUi outputMapping(Bd bd, Tenant tenant, Vrf vrf) {
		com.cisco.acisizer.ui.models.BdUi bdDest = new com.cisco.acisizer.ui.models.BdUi();
	...
	public com.cisco.acisizer.ui.models.BdUi addBd(int projectId, int tenantId, int vrfId,
			com.cisco.acisizer.ui.models.BdUi newBd) throws AciEntityNotFound {
		Tenant currTenant;
		Vrf currVrf = null;
	...
	public com.cisco.acisizer.ui.models.BdUi getBd(int projectId, int tenantId, int vrfId, int bdId)
	...
	public List<com.cisco.acisizer.ui.models.BdUi> getBds(int projectId, int tenantId, int vrfId)
			throws AciEntityNotFound {
	...
	public com.cisco.acisizer.ui.models.BdUi updateBd(int projectId, int tenantId, int vrfId, int bdId,
			com.cisco.acisizer.ui.models.BdUi bd) throws AciEntityNotFound, ForbiddenOperationException {
