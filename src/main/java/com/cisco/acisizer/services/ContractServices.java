...
public class ContractServices {
	...
	public void inputMapping(com.cisco.acisizer.ui.models.ContractUi src, Contract dest) {
	 ...
	 * @param tenant
	 */
	private void setProviderName(Contract src, com.cisco.acisizer.ui.models.ContractUi dest, Tenant tenant) {
	 ...
	 * @param commonTenant
	 */
	private void setConsumerName(Contract src, com.cisco.acisizer.ui.models.ContractUi dest, Tenant tenant,
			Tenant commonTenant) {
	...
	public com.cisco.acisizer.ui.models.ContractUi addContract(int projectId, int tenantId, int appId,
			com.cisco.acisizer.ui.models.ContractUi srcContract) throws AciEntityNotFound {
		...
		if (returnProj != null) {
			com.cisco.acisizer.ui.models.ContractUi contractAdded = new com.cisco.acisizer.ui.models.ContractUi();
	...
	public com.cisco.acisizer.ui.models.ContractUi updateContract(int projectId, int tenantId, int appId, int contractId,
			com.cisco.acisizer.ui.models.ContractUi srcContract) throws AciEntityNotFound {
		ProjectTable proj = m_projrepo.getOne(projectId);
		if (proj == null) {
			throw new AciEntityNotFound(ACISizerConstant.COULD_NOT_FIND_THE_PROJECT_FOR_ID);
		...
		if (returnProj != null) {
			com.cisco.acisizer.ui.models.ContractUi contractUpdated = new com.cisco.acisizer.ui.models.ContractUi();
	...
	public com.cisco.acisizer.ui.models.ContractUi getContract(int projectId, int tenantId, int appId, int contractId)
			throws AciEntityNotFound {
		...
		com.cisco.acisizer.ui.models.ContractUi contractReqd = new com.cisco.acisizer.ui.models.ContractUi();
		outputMapping(retContract, contractReqd, currTenant, Utility.getCommonTenant(logicalRequirement));
		return contractReqd;
	}

	
	public List<com.cisco.acisizer.ui.models.ContractUi> getContracts(int projectId, int tenantId, int appId)
			throws AciEntityNotFound {
