...
import com.cisco.acisizer.exceptions.BdNotFoundException;
import com.cisco.acisizer.exceptions.DeletionNotAllowedException;
import com.cisco.acisizer.exceptions.EpgNameExistsException;
...
import com.cisco.acisizer.util.AppUtilities;
...
public class EpgServices {
	...
	public void inputMapping(com.cisco.acisizer.ui.models.EpgUi src, Epg dest) {
		mapCommonFields(src, dest);
		dest.setBd("" + src.getBdId());
	}

	public com.cisco.acisizer.ui.models.EpgUi outputMapping(Epg src, com.cisco.acisizer.ui.models.EpgUi dest, Tenant currTenant, Tenant commonTenant) {
	...
	public com.cisco.acisizer.ui.models.EpgUi addEpg(int projectId, int tenantId, int appId,
			com.cisco.acisizer.ui.models.EpgUi epg) throws AciEntityNotFound, GenericInvalidDataException {
...
*/
		...
		if (returnProj != null) {
			com.cisco.acisizer.ui.models.EpgUi epgToReturn = new com.cisco.acisizer.ui.models.EpgUi();
...
/*	private void createContract(Tenant currTenant, Tenant commonTenant, Epg addedEpg, LogicalSummary logicalSummary) {
	...
	public com.cisco.acisizer.ui.models.EpgUi updateEpg(int projectId, int tenantId, int appId, int epgId,
			com.cisco.acisizer.ui.models.EpgUi epg) throws AciEntityNotFound {
		ProjectTable proj = projectRepo.getOne(projectId);
		if (proj == null) {
			throw new AciEntityNotFound(ACISizerConstant.COULD_NOT_FIND_THE_PROJECT_FOR_ID);
		}
		...
		if (returnProj != null) {
			com.cisco.acisizer.ui.models.EpgUi epgUpdated = new com.cisco.acisizer.ui.models.EpgUi();
	...
	public com.cisco.acisizer.ui.models.EpgUi getEpg(int projectId, int tenantId, int appId, int epgId)
	...
	public List<com.cisco.acisizer.ui.models.EpgUi> getEpgs(int projectId, int tenantId, int appId) throws AciEntityNotFound {
	 ...
	 * @param dest
	 */
	private void mapCommonFields(com.cisco.acisizer.ui.models.EpgUi src, Epg dest) {
		dest.setUiData(src.getUiData());
		dest.setPorts(src.getPorts());
