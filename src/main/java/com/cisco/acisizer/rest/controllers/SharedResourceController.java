...
import com.cisco.acisizer.services.SharedResourceServices;
...
public class SharedResourceController {
	...
	@RequestMapping(value = "/acisizer/v1/project/{projectId}/tenant/{tenantId}/vrf/{vrfId}/sharedResource", method = RequestMethod.POST, produces = "application/json")
	@ResponseBody
	...
	response = SharedResourceUi.class,
	responseContainer = "Self")
	@RequestMapping(value = "/acisizer/v1/project/{projectId}/tenant/{tenantId}/vrf/{vrfId}/sharedResource/{sharedResourceId}", method = RequestMethod.PUT, produces = "application/json")
	@ResponseBody
	...
	@RequestMapping(value = "/acisizer/v1/project/{projectId}/tenant/{tenantId}/vrf/{vrfId}/sharedResource/{sharedResourceId}", method = RequestMethod.DELETE, produces = "application/json")
	@ResponseBody
	...
	response = SharedResourceUi.class)
	@RequestMapping(value = "/acisizer/v1/project/{projectId}/tenant/{tenantId}/vrf/{vrfId}/sharedResource/{sharedResourceId}", method = RequestMethod.GET, produces = "application/json")
	@ResponseBody
