...
import com.cisco.acisizer.services.BdServices;
...
public class BdController {
	...
	@RequestMapping(value = "/acisizer/v1/project/{projectId}/tenant/{tenantId}/vrf/{vrfId}/bd", method = RequestMethod.POST, produces = "application/json")
	@ResponseBody
	...
	@RequestMapping(value = "/acisizer/v1/project/{projectId}/tenant/{tenantId}/vrf/{vrfId}/bd/{id}", method = RequestMethod.PUT, produces = "application/json")
	@ResponseBody
	...
	@RequestMapping(value = "/acisizer/v1/project/{projectId}/tenant/{tenantId}/vrf/{vrfId}/bd/{id}", method = RequestMethod.DELETE, produces = "application/json")
	@ResponseBody
	...
	@RequestMapping(value = "/acisizer/v1/project/{projectId}/tenant/{tenantId}/vrf/{vrfId}/bd/{id}", method = RequestMethod.GET, produces = "application/json")
	@ResponseBody
	...
	@RequestMapping(value = "/acisizer/v1/project/{projectId}/tenant/{tenantId}/vrf/{vrfId}/bds", method = RequestMethod.GET, produces = "application/json")
	@ResponseBody
