...
import com.cisco.acisizer.services.L3OutServices;
...
public class L3OutController {
	...
	@RequestMapping(value = "/acisizer/v1/project/{projectId}/tenant/{tenantId}/vrf/{vrfId}/l3Out", method = RequestMethod.POST, produces = "application/json")
	@ResponseBody
	...
	@RequestMapping(value = "/acisizer/v1/project/{projectId}/tenant/{tenantId}/vrf/{vrfId}/l3Out/{id}", method = RequestMethod.PUT, produces = "application/json")
	@ResponseBody
	...
	@RequestMapping(value = "/acisizer/v1/project/{projectId}/tenant/{tenantId}/vrf/{vrfId}/l3Out/{id}", method = RequestMethod.DELETE, produces = "application/json")
	@ResponseBody
	...
	@RequestMapping(value = "/acisizer/v1/project/{projectId}/tenant/{tenantId}/vrf/{vrfId}/l3Out/{id}", method = RequestMethod.GET, produces = "application/json")
	@ResponseBody
	...
	@RequestMapping(value = "/acisizer/v1/project/{projectId}/tenant/{tenantId}/vrf/{vrfId}/l3Outs", method = RequestMethod.GET, produces = "application/json")
	@ResponseBody
