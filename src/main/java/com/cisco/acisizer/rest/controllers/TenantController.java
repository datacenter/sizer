...
public class TenantController {
	...
	@RequestMapping(value = "/acisizer/v1/project/{projectId}/tenant", method = RequestMethod.POST, produces = "application/json")
	@ResponseBody
	...
	@RequestMapping(value = "/acisizer/v1/project/{projectId}/tenant/{id}", method = RequestMethod.PUT, produces = "application/json")
	@ResponseBody
	...
	@RequestMapping(value = "/acisizer/v1/project/{projectId}/tenant/{id}", method = RequestMethod.DELETE, produces = "application/json")
	@ResponseBody
	...
	@RequestMapping(value = "/acisizer/v1/project/{projectId}/tenant/{id}", method = RequestMethod.GET, produces = "application/json")
	@ResponseBody
	...
	@RequestMapping(value = "/acisizer/v1/project/{projectId}/tenants", method = RequestMethod.GET, produces = "application/json")
	@ResponseBody
	...
	@RequestMapping(value = "/acisizer/v1/project/{projectId}/tenant/{tenantId}/nodeCollection", method = RequestMethod.GET, produces = "application/json")
	@ResponseBody
	...
	@RequestMapping(value = "/acisizer/v1/project/{projectId}/tenant/{tenantId}/view", method = RequestMethod.POST, produces = "application/json")
	@ResponseBody
	...
	@RequestMapping(value = "/acisizer/v1/project/{projectId}/tenantTemplate", method = RequestMethod.POST, produces = "application/json")
	@ResponseBody
	...
	@RequestMapping(value = "/acisizer/v1/project/{projectId}/tenant/{tenantId}/nodeCollection/defaultValues", method = RequestMethod.GET, produces = "application/json")
	@ResponseBody
