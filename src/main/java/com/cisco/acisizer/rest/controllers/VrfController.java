...
import com.cisco.acisizer.services.VrfServices;
...
public class VrfController {
	...
	@RequestMapping(value = "/acisizer/v1/project/{projectId}/tenant/{tenantId}/vrf", method = RequestMethod.POST, produces = "application/json")
	@ResponseBody
	...
	@RequestMapping(value = "/acisizer/v1/project/{projectId}/tenant/{tenantId}/vrf/{id}", method = RequestMethod.PUT, produces = "application/json")
	@ResponseBody
	...
	@RequestMapping(value = "/acisizer/v1/project/{projectId}/tenant/{tenantId}/vrf/{id}", method = RequestMethod.DELETE, produces = "application/json")
	@ResponseBody
	...
	@RequestMapping(value = "/acisizer/v1/project/{projectId}/tenant/{tenantId}/vrf/{id}", method = RequestMethod.GET, produces = "application/json")
	@ResponseBody
	...
	@RequestMapping(value = "/acisizer/v1/project/{projectId}/tenant/{tenantId}/vrfs", method = RequestMethod.GET, produces = "application/json")
	@ResponseBody
