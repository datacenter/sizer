...
import com.cisco.acisizer.apic.models.App;
import com.cisco.acisizer.domain.RepoObjects;
import com.cisco.acisizer.models.Repos;
...
public class RepoDao {
	...
	public Repos RepoDaoService(String searchString, int startRecord, int numRecords, String sourceDeviceName,
		...
		if (!("" == endDate)) {
			cr.add(Restrictions.le(ApplicationProfilerConstants.IMPORTED_ON, endDate));
		}	
		cr.list();
