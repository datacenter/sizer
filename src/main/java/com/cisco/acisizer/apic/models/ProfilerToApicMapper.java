...
import com.cisco.acisizer.apic.models.FilterEntry.FilterEntryBuilder;
...
public class ProfilerToApicMapper {
	...
	public String mapProfilerToApic(com.cisco.acisizer.models.Tenant profilerTenant) {
	...
	private Tenant mapProfilerTenantToApicTenant(com.cisco.acisizer.models.Tenant profilerTenant) {
	...
	private void mapEpg(com.cisco.acisizer.models.Tenant profilerTenant, HashMap<String, String> bdIdNameMap,
			HashMap<String, App> appApicMap, HashMap<String, String> contractIdNameMap) {
		for (Epg epgProfiler : profilerTenant.getEpgs()) {
			com.cisco.acisizer.apic.models.Epg epg = new com.cisco.acisizer.apic.models.Epg();
	...
	private void mapProviderToEpg(HashMap<String, String> contractIdNameMap, Epg epgProfiler,
			com.cisco.acisizer.apic.models.Epg epg) {
	...
	private void mapBd(com.cisco.acisizer.models.Tenant profilerTenant, Tenant tenant,
			HashMap<String, String> vrfIdNameMap, HashMap<String, String> bdIdNameMap) {
		tenant.setBds(new ArrayList<Bd>());
		for (com.cisco.acisizer.models.Bd bdProfiler : profilerTenant.getBds()) {
			Bd bd = new Bd();
	...
	private void mapVrf(com.cisco.acisizer.models.Tenant profilerTenant, Tenant tenant,
			HashMap<String, String> vrfIdNameMap) {
		tenant.setVrfs(new ArrayList<com.cisco.acisizer.apic.models.Vrf>());
		for (Vrf vrfProfiler : profilerTenant.getVrfs()) {
			com.cisco.acisizer.apic.models.Vrf vrf = new com.cisco.acisizer.apic.models.Vrf();
	...
	private void mapApplication(com.cisco.acisizer.models.Tenant profilerTenant, Tenant tenant,
			HashMap<String, App> appApicMap) {
		tenant.setApps(new ArrayList<App>());
		for (Application appProfiler : profilerTenant.getApps()) {
			App app = new App();
			app.setEpgs(new ArrayList<com.cisco.acisizer.apic.models.Epg>());
	...
	private void mapContract(com.cisco.acisizer.models.Tenant profilerTenant, Tenant tenant,
			HashMap<String, String> contractIdNameMap) {
		tenant.setContracts(new ArrayList<Contract>());
		tenant.setFilters(new ArrayList<Filter>());
		for (com.cisco.acisizer.models.Contract contractProfiler : profilerTenant.getContracts()) {
	...
	private void mapProfilerContractToApicContract(com.cisco.acisizer.models.Contract contractProfiler,
		...
		for (com.cisco.acisizer.models.Subject subjectProfiler : contractProfiler.getSubjects()) {
			Subject subject = new Subject();
			subject.setName(subjectProfiler.getName());
			subject.setSubjectAttributes(new ArrayList<SubjectAttributes>());
			for (com.cisco.acisizer.models.Filter filterProfiler : subjectProfiler.getFilters()) {
	...
	private void mapProfilerFilterToApicFilter(com.cisco.acisizer.models.Filter filterProfiler,
			Filter filter) {
		filter.setName(filterProfiler.getName());
		filter.setFilterEntry(new ArrayList<FilterEntry>());
		for (com.cisco.acisizer.domain.FilterEntry filterEntryProfiler : filterProfiler.getFilterEntry()) {
